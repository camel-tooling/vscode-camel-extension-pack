...
import { ActivityBar, BottomBarPanel, Breakpoint, DebugView, EditorView, InputBox, TextEditor, VSBrowser, WebDriver } from "vscode-extension-tester";
...
import { DEMO_FILE, QUARKUS_ATTACH_DEBUGGER, QUARKUS_CREATE_COMMAND, QUARKUS_DIR, SPRINGBOOT_ATTACH_DEBUGGER, SPRINGBOOT_CREATE_COMMAND, SPRINGBOOT_DIR, SPRINGBOOT_PROJECT_FOLDER } from '../variables';
